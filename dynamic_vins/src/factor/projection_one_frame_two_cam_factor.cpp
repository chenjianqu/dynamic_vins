...
ProjectionOneFrameTwoCamFactor::ProjectionOneFrameTwoCamFactor(const Vec3d &_pts_i, const Vec3d &_pts_j,
...
bool ProjectionOneFrameTwoCamFactor::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
    ...
    Vec3d tic2(parameters[1][0], parameters[1][1], parameters[1][2]);
    ...
    Vec3d pts_camera_i = pts_i_td / inv_dep_i;
    Vec3d pts_imu_i = qic * pts_camera_i + tic;
    Vec3d pts_imu_j = pts_imu_i;
    Vec3d pts_camera_j = qic2.inverse() * (pts_imu_j - tic2);
    ...
    if (jacobians)
    {
        ...
        Mat3d ric2 = qic2.toRotationMatrix();
